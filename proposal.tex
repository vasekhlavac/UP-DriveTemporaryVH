...
%\input{abstract}
\input{text/section1Overview}
\input{text/section1Objectives}
\input{text/section1RelationToWorkProgramme}
\input{text/section1Concept}
\input{text/section1Ambition}
...
\input{text/section2Impact}
\input{text/section2ExpectedImpacts}
\input{text/section2Regulation}
\clearpage

\section{Implementation}
\input{text/section3WPPersonMonthNumbers}
\input{text/section3WPOverview}
\input{text/section3TaskOverview}
\input{text/section3Milestones}
\input{text/section3Deliverables}
\input{text/section3RiskAssessment}
\input{text/section3BudgetOverview}

\input{text/section3WPSpecification}
\input{text/section3WPVehicle}
\input{text/section3WPCloud}
\input{text/section3WPPerception}
\input{text/section3WPMapping}
\input{text/section3WPSceneUnderstanding}
\input{text/section3WPNavigation}
\input{text/section3WPIntegration}
\input{text/section3WPDisseminationExploitation}
\input{text/section3WPManagement}

\input{text/section3Management}
\input{text/section3Consortium}
